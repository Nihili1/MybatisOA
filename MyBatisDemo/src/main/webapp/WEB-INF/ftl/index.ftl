...
<head>
    <meta charset="UTF-8">
    <title>Zy's Office system</title>
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        <!--系统标题-->
        <div class="layui-logo" style="font-size:18px">Zy's Office system</div>
        <!--右侧当前用户信息-->
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                <a href="javascript:void(0)">
                    ...
                    <!--用户信息-->
                    ${currentEmp.empName}[${currentDept.deptName}-${currentEmp.title}]
                </a>
            </li>
            <!--注销按钮-->
    ...
    <div class="layui-body" style="overflow-y: hidden">
        <iframe name="ifmMain" src="/forward/notice" style="border: 0px;width: 100%;height: 100%">
        </iframe>
    </div>
    <!--版权信息-->
    <div class="layui-footer" style="text-align: center">
        Copyright © AkA-Zy. All Rights Reserved.
    </div>
</div>
<!--LayUI JS文件-->
